...
public class SearchPagingVO<T> {
	...
	public SearchPagingVO(int totalCount, int currentPage, int pageSize, int blockSize) {
	...
	public String getPageList() {
		...
		if(startPage>1) {
			...
			sb.append("<a class='page-link' href='#' aria-label='Previous' onclick='sendGet(\"?\", {\"p\":"+(startPage-1)+",\"s\":"+pageSize+",\"b\":"+blockSize+"})'>");
		...
		for(int i=startPage;i<=endPage;i++) {
			...
			if(i==currentPage) {
				...
				sb.append("<li class='page-item'>");
				sb.append("<a class='page-link' href='#' onclick='sendGet(\"?\", {\"p\":" + (i) + ",\"s\":"+pageSize+",\"b\":"+blockSize+"})'>");
				sb.append(i);
				sb.append("</a>");
				sb.append("</li>");				
			}
		...
		if(endPage<totalPage) {
			sb.append("<li class='page-item'>");
			sb.append("<a class='page-link' href='#' aria-label='Next' onclick='sendGet(\"?\", {\"p\":"+(endPage+1)+",\"s\":"+pageSize+",\"b\":"+blockSize+"})'>");
